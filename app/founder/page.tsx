    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        <HeroSection
          ...
          description="The visionary behind Excel Academy's success story"
          ...
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-3xl mx-auto">
                The guiding principles that drive Excel Academy's commitment to educational excellence
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              {founder.quotes.map((quote, index) => (
                <div
                  key={index}
                  className="bg-background rounded-xl p-6 shadow-sm border border-border/40 hover-card relative"
                >
        ...
        <section className="py-16 bg-gradient-to-r from-primary to-secondary text-white relative overflow-hidden">
          ...
          <div className="container text-center relative z-10">
            <h2 className="text-4xl font-bold mb-4">Join Excel Academy Today</h2>
            <p className="max-w-2xl mx-auto mb-10 text-white/90">
              Be a part of the educational journey envisioned by {founder.name} and take the first step towards academic
              excellence.
            </p>
